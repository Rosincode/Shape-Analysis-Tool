 ...
 */
public class Cylinder extends nl.thairosi.sat.Models.Shape {
     ...
     */
    public Cylinder(String name, ShapeType shapeType, double height, double diameter) {
     ...
     * @param diameter  is a dimension that is necessary for calculating the volume of this shape
     */
    public Cylinder(int id, String name, ShapeType shapeType, double height, double diameter) {
    ...
    public double calcVolume() {
        if (this.diameter > 0 && this.height > 0) {
            ...
            return DoubleUtils.round((Math.PI * Math.pow(radius, 2) * this.height) / 1000);
        } else {
            return 0;
        }
    }
