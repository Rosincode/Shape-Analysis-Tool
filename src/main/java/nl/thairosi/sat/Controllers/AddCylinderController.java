...
/**
 * The AddCylinderController class handles all necessary actions for adding the shape in a new FXML Stage
 */
public class AddCylinderController {
    ...
    public void addShape() {
        try {
            if (textHeight.getText().isBlank() || textDiameter.getText().isBlank() || textName.getText().isBlank()) {
                ...
                Cylinder cylinder = new Cylinder(name, ShapeType.CYLINDER, height, diameter);
                ShapeDAO shapeDAO = new ShapeDAO();
                shapeDAO.createShape(cylinder);
    ...
    public void calcVolume() {
        try {
            double height = Double.parseDouble(textHeight.getText());
            double diameter = Double.parseDouble(textDiameter.getText());
            Cylinder cylinder = new Cylinder("cylinder", ShapeType.CYLINDER, height, diameter);
